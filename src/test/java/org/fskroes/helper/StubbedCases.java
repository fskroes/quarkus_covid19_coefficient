...
public class StubbedCases {

    public static final String STUBBED_ALL_CASES = "{\n" +
            "    \"Afghanistan\": {\n" +
            "        \"All\": {\n" +
            "            \"confirmed\": 196992,\n" +
            "            \"recovered\": 0,\n" +
    ...
    public static final String STUBBED_EUROPE_CASES = "{\n" +
            "    \"Albania\": {\n" +
            "        \"All\": {\n" +
            "            \"confirmed\": 331459,\n" +
            "            \"recovered\": 0,\n" +
